...
// conversationIDPattern matches the IDs generated by generateID():
// "conv_" + 16 lowercase hex characters. Anything else (path separators,
// "..", arbitrary names) must be rejected to keep filePath inside basePath.
var conversationIDPattern = regexp.MustCompile(`^conv_[a-f0-9]{16}$`)

// IsValidConversationID reports whether id is a well-formed conversation
// identifier safe to use as a filename component.
